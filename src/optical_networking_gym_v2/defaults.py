...
MODULATION_CATALOG: dict[str, Modulation] = {
    "BPSK": Modulation("BPSK", 100_000.0, 1, minimum_osnr=3.71925646843142, inband_xt=-14.0),
    "QPSK": Modulation("QPSK", 2_000.0, 2, minimum_osnr=6.72955642507124, inband_xt=-17.0),
    "8QAM": Modulation("8QAM", 1_000.0, 3, minimum_osnr=10.8453935345953, inband_xt=-20.0),
    "16QAM": Modulation("16QAM", 500.0, 4, minimum_osnr=13.2406469649752, inband_xt=-23.0),
    "32QAM": Modulation("32QAM", 250.0, 5, minimum_osnr=16.160898294287, inband_xt=-26.0),
    "64QAM": Modulation("64QAM", 125.0, 6, minimum_osnr=19.013464934509, inband_xt=-29.0),
}
